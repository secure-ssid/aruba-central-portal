...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/aps/:serial-number/throughput-trends?interface-type=WIRELESS`

### Query Parameters

| Parameter | Value | Description |
|-----------|-------|-------------|
| interface-type | WIRELESS | Interface type of an access point for which the data being requested. |
...
#### The response object provides throghput trend of an access point.

...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/aps/:serial-number/tunnels/:tunnel-id/throughput-trends`
...
#### The response object provides throughput trend of an access point tunnel.
...
```json
{
  ...
  "id": "AP00000001/tunnels/Tunnel1~Primary",

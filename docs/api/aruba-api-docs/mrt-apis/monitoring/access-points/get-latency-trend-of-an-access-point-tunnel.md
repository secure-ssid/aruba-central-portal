...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/aps/:serial-number/tunnels/:tunnel-id/latency-trends`
...
#### The response object provides probe trends of an access point.

...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/aps/:serial-number/radios/:radio-number/frames-trends`
...
#### The response object contains transmission trend data for Drops, Errors, and Retries Frames for a radio.

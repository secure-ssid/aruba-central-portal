...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/aps/:serial-number/ports/:port-index/frames-trends`
...
#### The response object contains transmission trend data for Drops, Errors Frames (with percentage) for a port of an access point.

...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/uplinks/:vlan-id/vpn-availability-trends`
...
#### The response object provides VPN availability trends of the specified gateway uplink.
...
[
  {
    ...
    "id": "GW00000001/uplinks/airtel/vpn-availability-trends",

...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/ports/:port-number/frames-packets-trends`
...
#### The response object provides the data of the packets processed in broadcast and muticast.
...
```json
{
  ...
  "id": "gw1/ports/GE 0/0/1/frames-packets-trends",

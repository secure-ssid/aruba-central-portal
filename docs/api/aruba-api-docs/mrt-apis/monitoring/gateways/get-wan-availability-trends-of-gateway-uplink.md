...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/uplinks/:link-tag/wan-availability-trends`
...
#### The response object provides WAN availability trends of the specified gateway uplink.
...
[
  {
    ...
    "id": "GW00000001/uplinks/airtel/wan-availability-trends",
    "type": "network-monitoring/gateway-monitoring"
  },
  {
    "metric": "health_check_ip",
    "graph": {
      "keys": [
        "health_check_ip"
      ],

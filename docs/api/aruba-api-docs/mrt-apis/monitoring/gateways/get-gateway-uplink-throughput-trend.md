...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/uplinks/:link-tag/throughput-trends`
...
#### The response object provides throughput trends of a gateway interface.

...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/clusters/:cluster-name/capacity-trends/:serial-number`
...
#### The response object provides the client and device capacity trend of a gateway cluster member.

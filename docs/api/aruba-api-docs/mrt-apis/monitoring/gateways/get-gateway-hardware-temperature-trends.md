...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/hardware-temperature-trends`
...
#### The response object provides hardware temperature trends of gateway.

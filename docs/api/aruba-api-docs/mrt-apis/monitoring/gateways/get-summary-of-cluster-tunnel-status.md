...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/clusters/:cluster-name/tunnels-status-summary`
...
#### Object containing the count of inter-gateway tunnels that are Up and Down in a cluster.

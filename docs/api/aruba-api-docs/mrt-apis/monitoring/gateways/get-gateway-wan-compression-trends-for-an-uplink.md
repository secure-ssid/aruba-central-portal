...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/uplinks/:link-tag/wan-compression-trends`
...
#### The response object provides the WAN compression trends of a gateway uplink interface.

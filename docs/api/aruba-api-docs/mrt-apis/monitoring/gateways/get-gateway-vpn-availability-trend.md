...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/vpn-availability-trends`
...
#### The response object provides VPN availabilty trends of a gateway.

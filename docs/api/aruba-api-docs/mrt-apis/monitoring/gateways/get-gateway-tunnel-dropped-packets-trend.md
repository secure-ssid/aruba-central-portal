...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/lan-tunnels/:tunnel-name/packets-trends`
...
#### The response object provides the trend of dropped packets by the tunnel.
...
```json
{
  ...
  "id": "gw1/tunnels/ap-ipsecmap-00:44:55:66:79:22",

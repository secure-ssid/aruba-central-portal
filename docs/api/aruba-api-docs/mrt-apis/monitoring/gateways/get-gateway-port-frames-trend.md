...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/ports/:port-number/frames-trends`
...
#### The response object provides the data of the broadcastMulticast frames and its related error percentage.
...
```json
{
  ...
  "id": "gw1/ports/GE 0/0/1/frames-trends",

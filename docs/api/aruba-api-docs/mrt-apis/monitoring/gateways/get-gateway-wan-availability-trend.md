...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/wan-availability-trends`
...
#### The response object provides WAN availabilty trends of a gateway.

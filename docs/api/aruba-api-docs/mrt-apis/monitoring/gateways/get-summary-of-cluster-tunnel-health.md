...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/clusters/:cluster-name/tunnels-health-summary`
...
#### Object containing information about the health summary of tunnels present in cluster.
...
[
  {
    ...
    "id": "cluster1/GW1/tunnels",
    "type": "network-monitoring/gateway-monitoring"
  },
  {
    "deviceName": "Gateway-2",
    "serialNumber": "GW2",
    "siteId": "12345",
    "tunnelHealth": {
      "good": 1,

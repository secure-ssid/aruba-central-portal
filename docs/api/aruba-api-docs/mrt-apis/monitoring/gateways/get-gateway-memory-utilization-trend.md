...
**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/memory-utilization-trends`
...
#### The response object provides memory utilisation trends of gateway.

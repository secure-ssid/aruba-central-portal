# Get gateway WAN tunnel status trend

## Request

**Method:** `GET`

**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/gateways/:serial-number/wan-tunnels/:tunnel-name/status-trends`
...
#### The response object provides status trends of a gateway tunnel.

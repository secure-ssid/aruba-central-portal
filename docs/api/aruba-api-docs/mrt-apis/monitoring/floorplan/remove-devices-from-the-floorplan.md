# Remove devices from the FloorPlan

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-monitoring/v1alpha1/sitemaps/:site-id/network-devices-undeploy`
...
#### Removed devices from the floor assignement status will be maintained.

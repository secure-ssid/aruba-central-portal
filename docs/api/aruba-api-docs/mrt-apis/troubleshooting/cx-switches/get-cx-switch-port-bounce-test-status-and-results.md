...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/cx/:serial-number/portBounce/async-operations/:task-id`
...
#### OK. Returns the status and results of the CX Switch Port Bounce test.
...
```json
{
  ...
  "endTime": "2025-05-20T09:35:05.344339885Z",
  "progressPercent": 100,
  "startTime": "2025-05-20T09:35:03.080589059Z"
}
```
---

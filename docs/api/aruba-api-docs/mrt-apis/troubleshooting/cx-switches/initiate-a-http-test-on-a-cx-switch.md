...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/cx/:serial-number/http`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/cx/{serial-number}/http/async-operations/{task-id}",
  "status": "INITIATED",

...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/cx/:serial-number/traceroute`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/cx/{serial-number}/traceroute/async-operations/{task-id}",
  "status": "INITIATED",

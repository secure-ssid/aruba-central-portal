...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/cx/:serial-number/portBounce`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/cx/{serial-number}/portBounce/async-operations/{task-id}",
  "status": "INITIATED",

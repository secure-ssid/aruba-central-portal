...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/cx/:serial-number/aaa`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/cx/{serial-number}/aaa/async-operations/{task-id}",
  "status": "INITIATED",

...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/gateways/:serial-number/getArpTable`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/gateways/{serial-number}/getArpTable/async-operations/{task-id}",
  "status": "INITIATED",

# Run a 'show' command (Gateway)

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/gateways/:serial-number/showCommand`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/gateways/{serial-number}/showCommand/async-operations/{task-id}",
  "status": "INITIATED",

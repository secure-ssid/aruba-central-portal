...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/gateways/:serial-number/portBounce/async-operations/:task-id`
...
#### OK. Returns the status and results of the Gateway Port Bounce test.

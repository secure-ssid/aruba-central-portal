...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/gateways/:serial-number/portBounce`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/gateways/{serial-number}/portBounce/async-operations/{task-id}",
  "status": "INITIATED",

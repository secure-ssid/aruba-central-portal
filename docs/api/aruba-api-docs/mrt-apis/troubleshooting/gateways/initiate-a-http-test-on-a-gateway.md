...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/gateways/:serial-number/http`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/gateways/{serial-number}/http/async-operations/{task-id}",
  "status": "INITIATED",

# Locate a AOS-S Switch

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aos-s/:serial-number/locate`
...
#### Conflict. The device is already performing locate.
...
```json
{
  "summary": "Device Already Locating",
  "value": {
    "serviceName": "Troubleshooting",
    "httpStatusCode": "409",
    "message": "Device already locating: VN2ZLHB006",

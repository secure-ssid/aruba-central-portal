...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aos-s/:serial-number/traceroute/async-operations/:task-id`
...
#### OK. Returns the status and results of the AOS-S Switch Traceroute test.

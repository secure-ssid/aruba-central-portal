...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aos-s/:serial-number/ping`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aos-s/{serial-number}/ping/async-operations/{task-id}",
  "status": "INITIATED",

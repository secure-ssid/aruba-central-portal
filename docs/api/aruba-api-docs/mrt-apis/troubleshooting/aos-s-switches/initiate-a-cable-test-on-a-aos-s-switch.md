...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aos-s/:serial-number/cableTest`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aos-s/{serial-number}/cableTest/async-operations/{task-id}",
  "status": "INITIATED",

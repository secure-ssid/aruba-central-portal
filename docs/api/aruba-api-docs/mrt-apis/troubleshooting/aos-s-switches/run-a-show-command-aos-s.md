# Run a 'show' command (AOS-S)

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aos-s/:serial-number/showCommand`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aos-s/{serial-number}/showCommand/async-operations/{task-id}",
  "status": "INITIATED",

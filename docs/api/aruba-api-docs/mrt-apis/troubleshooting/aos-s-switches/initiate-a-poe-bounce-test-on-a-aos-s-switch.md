...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aos-s/:serial-number/poeBounce`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aos-s/{serial-number}/poeBounce/async-operations/{task-id}",
  "status": "INITIATED",

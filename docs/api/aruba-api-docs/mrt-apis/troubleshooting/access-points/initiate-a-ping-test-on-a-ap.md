# Initiate a Ping test on a AP

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/ping`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aps/{serial-number}/ping/async-operations/{task-id}",
  "status": "INITIATED",

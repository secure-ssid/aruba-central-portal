# Initiate a Traceroute test on a AP

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/traceroute`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aps/{serial-number}/traceroute/async-operations/{task-id}",
  "status": "INITIATED",

# Get 'show' command status/result (AP)

## Request

**Method:** `GET`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/showCommand/async-operations/:task-id`
...
#### OK. Returns the status and result for the run 'show' command.
...
```json
{
  "status": "COMPLETED",
  "progressPercent": 100,
  "startTime": "2025-08-25T10:00:01Z",
  "endTime": "2025-08-25T10:00:05Z",
  "failReason": null,
  "output": {
    "command": "show interface brief",
    "response": "Port  Link  Speed  Duplex ...\n..."
  }
}
```
---

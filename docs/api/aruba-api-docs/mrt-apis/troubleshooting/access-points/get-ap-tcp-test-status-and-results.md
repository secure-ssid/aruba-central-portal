...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/tcp/async-operations/:task-id`
...
#### OK. Returns the status and results of the AP Tcp test.
...
```json
{
  "startTime": "2025-05-20T13:23:33.299455647Z",
  "endTime": "2025-05-20T13:23:34.121460257Z",
  "output": {
    "host": "www.google.com",
    "connectionTimeInMilliseconds": "209"
  },
  "failReason": null,
  "progressPercent": 100,
  "status": "COMPLETED"

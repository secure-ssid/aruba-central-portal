# Initiate a Get Arp Table test on a AP

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/getArpTable`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aps/{serial-number}/getArpTable/async-operations/{task-id}",
  "status": "INITIATED",

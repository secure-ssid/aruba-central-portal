# Initiate a Http test on a AP

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/http`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aps/{serial-number}/http/async-operations/{task-id}",
  "status": "INITIATED",

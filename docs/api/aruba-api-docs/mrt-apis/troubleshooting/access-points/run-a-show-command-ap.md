# Run a 'show' command (AP)

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/showCommand`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aps/{serial-number}/showCommand/async-operations/{task-id}",
  "status": "INITIATED",

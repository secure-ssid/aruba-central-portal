# Initiate a Https test on a AP

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/https`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aps/{serial-number}/https/async-operations/{task-id}",
  "status": "INITIATED",

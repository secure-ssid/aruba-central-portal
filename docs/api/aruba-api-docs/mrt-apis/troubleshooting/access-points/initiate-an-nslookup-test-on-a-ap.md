# Initiate an Nslookup test on a AP

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/nslookup`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aps/{serial-number}/nslookup/async-operations/{task-id}",
  "status": "INITIATED",

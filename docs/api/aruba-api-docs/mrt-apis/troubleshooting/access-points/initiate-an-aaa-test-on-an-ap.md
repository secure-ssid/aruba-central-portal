...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/aaa`
...
#### Accepted. The operation has been successfully initiated.
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aps/{serial-number}/aaa/async-operations/{task-id}",
  "status": "INITIATED",

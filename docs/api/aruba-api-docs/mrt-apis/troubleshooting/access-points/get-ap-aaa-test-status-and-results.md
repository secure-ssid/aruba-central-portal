...
**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/aaa/async-operations/:task-id`
...
#### OK. Returns the status and results of the AP AAA test.
...
```json
{
  "startTime": "2025-07-22T10:00:05Z",
  "endTime": "2025-07-22T10:00:07Z",
  "progressPercent": 100,
  "status": "COMPLETED",
  "failReason": null,
  "output": {

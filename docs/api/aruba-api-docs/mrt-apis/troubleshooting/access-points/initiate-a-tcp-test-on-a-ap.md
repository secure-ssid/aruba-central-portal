# Initiate a Tcp test on a AP

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/tcp`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aps/{serial-number}/tcp/async-operations/{task-id}",
  "status": "INITIATED",

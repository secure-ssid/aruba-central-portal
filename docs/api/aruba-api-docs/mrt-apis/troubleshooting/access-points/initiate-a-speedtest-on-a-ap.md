# Initiate a Speedtest on a AP

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-troubleshooting/v1alpha1/aps/:serial-number/speedtest`
...
```json
{
  "location": "/network-troubleshooting/v1alpha1/aps/{serial-number}/speedtest/async-operations/{task-id}",
  "status": "INITIATED",

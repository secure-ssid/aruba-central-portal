# Read configuration of WLAN SSID profile

## Request

**Method:** `GET`

**URL:** `{{baseUrl}}/network-config/v1alpha1/wlan-ssids`
  ...
  "wlan-ssid": [
    {
      ...
      "g-legacy-rates": {
        ...
        "beacon-rate": "RATE_2MB",
        "max-tx-rate": "RATE_48MB",
        "min-tx-rate": "RATE_48MB",
        "tx-rates": [
          "RATE_18MB"
        ]
      },

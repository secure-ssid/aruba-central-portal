# Read existing Hotspot2 related settings.

## Request

**Method:** `GET`

**URL:** `{{baseUrl}}/network-config/v1alpha1/hotspot2`
  ...
  "hs-profile": [
    {
      ...
      "advertisement-profile": [
        ...
        {
          "profile-type": "H2QP_OSU_PROVIDER",
          "anqp-3gpp": [
            "<string>",
            "<string>"
          ],

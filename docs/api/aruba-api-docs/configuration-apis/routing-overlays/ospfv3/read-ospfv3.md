...
**URL:** `{{baseUrl}}/network-config/v1alpha1/ospfv3`
          ...
          "ether-interfaces": [
            {
              ...
              "encryption": "false",
              "encryption-type": "AES",
              "encryption-key-type": "CIPHER_TEXT",
      ...
      "redistribute-routes": [
        {
          ...
          "redistribute-type": "LOCAL_LOOPBACK",
          "id": "<integer>",
          "route-map": "<string>"
        }
      ],

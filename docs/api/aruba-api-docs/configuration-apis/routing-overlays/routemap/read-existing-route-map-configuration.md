# Read existing route-map configuration

## Request

**Method:** `GET`

**URL:** `{{baseUrl}}/network-config/v1alpha1/route-maps`
      ...
      "route-map-entry": [
        {
          ...
          "match-metric": "<long>",
          "match-external-route-type": "TYPE_2",
          "match-route-type": "EVPN_TYPE_4",

# Read existing BGP profile.

## Request

**Method:** `GET`

**URL:** `{{baseUrl}}/network-config/v1alpha1/bgp/:name`
      ...
      "neighbor": [
        {
          ...
          "enabled": "true",
          "local-as": "<long>",
          "local-as-mode": "NO_PREPEND_REPLACE_AS_DUAL_AS",
      ...
      "peer-group": [
        {
          "enabled": "true",
          "local-as": "<long>",
          "local-as-mode": "NO_PREPEND_REPLACE_AS",
          "auth-password": "<string>",
          "remove-private-as": "false",
          "description": "<string>",
          "fall-over": "false",

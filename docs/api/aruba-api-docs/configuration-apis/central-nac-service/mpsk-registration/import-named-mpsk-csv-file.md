# Import Named MPSK csv file

## Request

**Method:** `POST`

**URL:** `{{baseUrl}}/network-config/v1alpha1/cnac-named-mpsk-reg/import`
...
#### Success. The file has been uploaded and the import job has started.

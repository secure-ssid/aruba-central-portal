# Read  authentication profile configuration(s).

## Request

**Method:** `GET`

**URL:** `{{baseUrl}}/network-config/v1alpha1/auth-profiles`
  ...
  "profile": [
    {
      ...
      "eap": {
        "ocsp-url": "<string>",
        "ocsp-fail-behavior": "ACCEPT_VALID_CERT",
        "server-cert": "<string>",
        "server-key": "<string>",

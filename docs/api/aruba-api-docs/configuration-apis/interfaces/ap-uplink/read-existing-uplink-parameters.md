# Read existing uplink parameters

## Request

**Method:** `GET`

**URL:** `{{baseUrl}}/network-config/v1alpha1/ap-uplinks`
  ...
  "profile": [
    {
      ...
      "lte-modem": {
        ...
        "gps": "false",
        "network-mode": "MODE_4G",
        "sim-slot": "SLOT_2",
        "data-rate-limit": "<integer>",
        "billing-start-date": "<long>",
        "modem-e3372": "false",
        "generation": "GENERATION_3G",
        "frequency-range": "LTE_B14_700",
        "auto-upgrade": "false",
        "sim-failover": "false",
        "prefer-modem": "MODEM_1",
        "tp-driver-type": "SIERRA_EVDO",
        "tp-device-id": "<string>",

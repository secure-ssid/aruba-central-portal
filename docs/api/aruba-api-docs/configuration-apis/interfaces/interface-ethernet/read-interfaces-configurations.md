# Read interface(s) configurations

## Request

**Method:** `GET`

**URL:** `{{baseUrl}}/network-config/v1alpha1/ethernet-interfaces`
  ...
  "interface": [
    {
      ...
      "exclude-app-cat-contract": {
        "exclude-app-category": [
          {
            "exclude-app-category-name": "CUSTOM"
          }
        ]
      },
      "aaa-bw-contract": {

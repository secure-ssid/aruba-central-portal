# Read existing port profile configuration

## Request

**Method:** `GET`

**URL:** `{{baseUrl}}/network-config/v1alpha1/ap-port-profiles/:profileName`
...
```json
{
  ...
  "assignment-rules": {
    "assignment-rule": [
      ...
      {
        "sequence-id": "<long>",
        "attribute": "ARUBA_PRIV_ADMIN_USER",
        "attribute-str": "<string>",
